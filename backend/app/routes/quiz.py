...
from ..models.quiz import (
    QuizRequest, QuizResponse, QuizSubmission, QuizResult, QuizHistory
)
from ..services.quiz_service import quiz_service
from ..database import get_async_db
from ..services.database_service import QuizService, QuizQuestionService, QuizSubmissionService
from ..models.database_models import Quiz, QuizQuestion, QuizSubmission as DBQuizSubmission
...
async def generate_quiz(request: QuizRequest, force_model: str = None, db: AsyncSession = Depends(get_async_db)):
